...
function carregaListaDespesas(despesas = Array(), filtro = false){
    ...
    //SE NAO RECEBE PARAMETRO CARREGA TODOS OS REGISTROS
    ...
    despesas.forEach(function(d){
        ...
        btn.onclick = function(){ 
            ...
            document.getElementById('modal_body').innerHTML       = 'Despesa foi excluída com sucesso!'
            document.getElementById('modal_button').className     = 'btn btn-warning'
            document.getElementById('modal_button').innerHTML     = 'Voltar'
            $('#modalRegistraDespesa').modal('show')            
        }
